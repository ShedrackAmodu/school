// JavaScript for student_timetable.html
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadTimetable() {
        ...
        if (sessionId && termId) {
            ...
            // Example: fetch(`/api/student-timetable/?session=${sessionId}&term=${termId}`)
    ...
    // Add any other specific JS for student timetable here
});
