            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        db_index=True,
                        help_text="Optional username that can be used for login in addition to email",
                        max_length=150,
                        null=True,
                        unique=True,
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="users_users_user_id_3581cd_idx",
                    ),
                    models.Index(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="users_userr_user_id_98b8d4_idx",
                    ),
                    models.Index(
                        fields=["role", "created_at"],
                        name="users_userr_role_id_7e5b02_idx",
                    ),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["role"], name="users_userr_role_id_fcacec_idx"
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="users_userp_identif_1bd48a_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["email"], name="users_stude_email_3159e0_idx"),
                    models.Index(
                        fields=["application_number"],
                        name="users_stude_applica_f72d2c_idx",
                    ),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["email"], name="users_staff_email_a2fa4a_idx"),
                    models.Index(
                        fields=["application_number"],
                        name="users_staff_applica_e8ad85_idx",
                    ),
                    models.Index(
                        fields=["position_applied_for"],
                        name="users_staff_positio_03a0c5_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "created_at"],
                        name="users_passw_user_id_053982_idx",
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "created_at"],
                        name="users_login_user_id_0a4ab0_idx",
                    ),
                    models.Index(
